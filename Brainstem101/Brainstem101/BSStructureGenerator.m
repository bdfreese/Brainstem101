...
- (id)init
{
    ...
    if (self) {
        ...
        Nuclei = [[NSMutableArray alloc] init];
        Tracts = [[NSMutableArray alloc] init];
...
-(void) addData{
    ...
    [Nuclei addObject:nn8]; // CONFUSED -- two 4's and nuc and tract?
    ...
    [Nuclei addObject:n10]; //THIS IS A TRACT AND A NUCLEIUS
    ...
    [Tracts addObject:t3]; // CONFUSED, fibers/tract, and no section 6
    ...
    [Tracts addObject:tt1]; // CONFUSED -- streaks on 2 and 3, is this right?
    ...
    [Tracts addObject:tt2]; // CONFUSED -- peduncle == tract? medial vs. middle??
